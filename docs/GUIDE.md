...
For the short CLI and SDK quickstart, see the [README](../README.md). This guide preserves the starter instructions, diagnostic workflows, and implementation background.
